			...
			try {
				...
				Notification notification  = nBuilder
						...
						.setWhen( System.currentTimeMillis())
							...
							.setContentText(this.getString(R.string.notification_ticker)).build();
				...
				notification  = nBuilder
						.setContentIntent(contentIntent)
						.setSmallIcon(R.drawable.ic_launcher)
						.setWhen( System.currentTimeMillis())
						.setContentTitle("App notification: ")
						.setContentText(this.getString(R.string.notification_title)).build();
